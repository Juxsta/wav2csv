...
Welcome to ``wav2csv`` contributor's guide.
...
If you experience bugs or general issues with ``wav2csv``, please have a look
...
You can help improve ``wav2csv`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``wav2csv`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``wav2csv``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n wav2csv python=3 six virtualenv pytest pytest-cov
    conda activate wav2csv
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/wav2csv.git
    cd wav2csv
...
#. Install |pre-commit|_::
   ...
   ``wav2csv`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/wav2csv
.. _issue tracker: https://github.com/<USERNAME>/wav2csv/issues
.. <-- end -->
